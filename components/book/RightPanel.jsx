...
export default function RightPanel({
  ...
  return (
    <>
      ...
      >
        <h2 className="mt-12 text-3xl font-bold text-center mobile-lg:text-2xl">
          დაჯავშნილია
        </h2>
        <hr className="w-full mt-4 mb-20 bg-black/30" />
        ...
        {isSuccessful ? (
          <>
            <div className="flex justify-center">
              <svg
                ...
                viewBox="0 0 24 24"
                strokeWidth={4}
                className="p-2 bg-green-600 rounded-full size-10 stroke-white"
              >
                <path
                  strokeLinecap="round"
            ...
            <p className="text-center text-lg max-w-[350px] mt-4 mobile-lg:max-w-[250px] mobile-lg:text-base">
              ოთახი დაჯავშნილია, დამატებითი ინფორმაციისთვის დაგვიკავშირდით
              ნომერზე
            </p>
          </>
        ) : (
          <>
            ...
            <p className="text-center text-lg max-w-[350px] mt-4">
              გთხოვთ დაჯავშნა სცადოთ თავიდან ან დაგვიკავშირდით ტელეფონის ნომერზე
        ...
        <button
          type="button"
          onClick={handleClose}
          className="absolute cursor-pointer top-4 right-4 hover:opacity-70"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
